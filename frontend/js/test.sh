cd /home/gokul/Programs/web/software/employee-payroll-system/frontend/js

# Delete the broken file
rm -f employees.js

# Create with properly escaped quotes
python3 << 'PYEND'
employees_js = r"""const API_URL = 'http://localhost:3000/api';
...
console.log('employees.js fully loaded');
"""

with open('employees.js', 'w') as f:
    f.write(employees_js)

print("✓ employees.js created with proper escaping")
PYEND

# Verify
node -c employees.js && echo "✓ No syntax errors!" || echo "✗ Still has errors"
